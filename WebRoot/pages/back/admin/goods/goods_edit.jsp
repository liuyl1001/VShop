...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String editUrl = basePath + "pages/back/admin/goods/GoodsActionBack!edit.action" ;
%>
...
<script type="text/javascript">
	var temp_iid = "${goods.item.iid}" ;
	var temp_sid = "${goods.subitem.sid}" ;
</script>
</head>
<body class="back">
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-5 col-md-offset-3">
										<input type="hidden" id="goods.gid" name="goods.gid" value="${goods.gid}">
										<input type="hidden" id="goods.photo" name="goods.photo" value="${goods.photo}">
